...
st.markdown("""
    <div class="center">
        <img src="https://media.tenor.com/0qJo9Qg6bfYAAAAi/welcome-images-server.gif" alt="Welcome Image">
    </div>
""", unsafe_allow_html=True)

st.markdown("<h1 style='text-align: center; color: #ACAF50;'>Prediksi IPK - 2138</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; color: #007a66;'>Aplikasi ini berguna untuk memprediksi IPK berdasarkan nilai Matematika, Bahasa Inggris, dan Bahasa Indonesia</p>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    st.write("<h3 style='text-align: center; color: #007a66;'>Data yang diupload:</h3>", unsafe_allow_html=True)
    st.dataframe(input_data)

    model_directory = r'C:\Tery\.Semester 5\ML\Model Suprevised Learning (Praktek)\Tugas3_A_12138'
